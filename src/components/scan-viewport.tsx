...
export function ScanViewport() {
  ...
  return (
    <div className="relative overflow-hidden rounded-[var(--radius-xl)] bg-surface p-3 shadow-[var(--shadow-border)]">
      <div className="relative overflow-hidden rounded-[var(--radius-lg)] bg-bg scan-grid min-h-[340px] sm:min-h-[400px]">
        <div className="absolute inset-x-0 top-0 z-20 flex items-center justify-between px-4 py-3">
          ...
          <span className="flex items-center gap-2 font-mono text-[11px] text-pass">
        ...
        <div className="absolute left-1/2 top-[46%] z-10 w-[min(78%,280px)] -translate-x-1/2 -translate-y-1/2">
          <div className="relative aspect-[3/4] rounded-[var(--radius-md)] shadow-[var(--shadow-border)] bg-surface-2">
            <div className="absolute left-3 top-3 right-3 flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-accent">ID-04</span>
            </div>
            <div className="absolute left-1/2 top-[38%] h-[42%] w-[46%] -translate-x-1/2 -translate-y-1/2 rounded-[40%] bg-surface shadow-[inset_0_0_0_1px_rgb(255_255_255/0.08)]">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden">
          <div className="animate-scan absolute inset-x-8 h-px bg-accent/70 shadow-[0_0_16px_var(--color-accent)]" />
        </div>
...
function Reticule() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M8 22 V8 H22" stroke="currentColor" strokeWidth="1.2" />
      <path d="M78 8 H92 V22" stroke="currentColor" strokeWidth="1.2" />
      <path d="M92 78 V92 H78" stroke="currentColor" strokeWidth="1.2" />
      <path d="M22 92 H8 V78" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}
